    ...
    return (
        <nav className="flex items-center justify-between flex-wrap bg-primary p-6">
            ...
            <div className="block lg:hidden">
                <button onClick={() => {setShowLinks(!showLinks)}} className="flex items-center px-3 py-2 border rounded text-primaryblue border-teal-400 hover:text-hoverblue hover:border-white">
