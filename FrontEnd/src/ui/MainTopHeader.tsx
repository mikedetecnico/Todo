    ...
    return (
        <nav className="flex items-center justify-between flex-wrap bg-primary p-6">
            ...
            <div className="block lg:hidden">
                <button type='button' onClick={() => {setShowLinks(!showLinks)}} className="flex items-center px-3 py-2 border rounded text-primaryblue border-teal-400 hover:text-hoverblue hover:border-white" title="Toggle Menu">
            ...
            </div>
            {
                ...
                <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    <div className="text-sm lg:flex-grow">
                        <a href="/signup" className="block mt-4 lg:inline-block lg:mt-0 text-primaryblue hover:text-hoverblue mr-4">
                            Sign up
                        </a>
                        <a href="/login" className="block mt-4 lg:inline-block lg:mt-0 text-primaryblue hover:text-hoverblue mr-4">
                            Login
                        </a>
                    </div>
                </div>)
